...
# Threshold đã calibrate thực tế trên corpus + embedding model hiện tại
# (paraphrase-multilingual-MiniLM-L12-v2, KHÔNG phải bge-m3 nên thang điểm khác):
#   Câu hỏi liên quan   -> top cosine score: 0.85 / 0.41 / 0.70
#   Câu hỏi lạc đề/rác  -> top cosine score: 0.32 / 0.06 / 0.21
# 0.35 nằm giữa 2 nhóm nên tách đúng cả 2 phía trong lần đo trên.
