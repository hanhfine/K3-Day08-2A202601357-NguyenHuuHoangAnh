...
# =============================================================================
# LLM CLIENT — chọn provider theo API key đang có trong .env
# =============================================================================

def _get_llm_client():
    """
    OpenRouter là lựa chọn chính (model ID có prefix provider, vd "openai/gpt-4o-mini").
    Nếu không có OPENROUTER_API_KEY, fallback sang gọi thẳng OpenAI (bỏ prefix
    "openai/" vì OpenAI SDK gốc không dùng prefix đó).
    """
    ...
    raise RuntimeError("Chưa có OPENROUTER_API_KEY hoặc OPENAI_API_KEY trong .env")
...
def generate_with_citation(query: str, top_k: int = TOP_K) -> dict:
    ...
    # Step 5: Call LLM (OpenRouter hoặc OpenAI, tuỳ key có trong .env)
